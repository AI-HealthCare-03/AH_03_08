...
@celery_app.task(name="ai_worker.tasks.image_tasks.generate_card_image_task")
def generate_card_image_task(asset_id: int, guide_id: int):
    # TODO: 카드뉴스 이미지 생성 구현
    pass


@celery_app.task(name="ai_worker.tasks.image_tasks.generate_daily_tip_card_task")
